...
return [
    ...
    */
    ...
    'custom' => [
        ...
        'cover.uploaded' => 'La carátula supera el límite permitido de 1 MB.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Nombres legibles para los campos usados en los formularios de la app,
    | para que el mensaje diga "El campo título..." en vez de "...title...".
    */
    ...
    'attributes' => [
        ...
        'genres' => 'géneros',
        'status' => 'propiedad',
        'play_status' => 'estado de juego',
        'rating' => 'valoración',
        'price_paid' => 'precio pagado',
        'purchase_place' => 'lugar de compra',
        'purchase_date' => 'fecha de compra',
        'manual_status' => 'manual',
        'region_select' => 'región',
        'region_other' => 'región',
        'age_rating' => 'clasificación por edad',
        'notes' => 'notas',
        'cover' => 'carátula',
        'name' => 'nombre',
        'label' => 'etiqueta',
        ...
        'text_color' => 'color de letras',
        'border_color' => 'color de borde',
        'platform_ids' => 'plataformas',
        'email' => 'email',
        'password' => 'contraseña',
