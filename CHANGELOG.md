...
## 2026-08-06
- **Buscar carátula en CEX** desde el formulario de edición de un juego ya guardado: botón que busca en el catálogo externo (por EAN si el juego lo tiene, si no por título) y deja elegir la carátula entre los resultados, mostrando su plataforma para evitar confundir ediciones. No se descarga hasta guardar, igual que la sugerencia de CEX en el alta. De paso, las sugerencias de CEX en la búsqueda rápida (Ctrl+K) también muestran ahora la plataforma de cada resultado (dato que CEX ya devolvía y no se estaba usando).
