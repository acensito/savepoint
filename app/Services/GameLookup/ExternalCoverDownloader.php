...
/**
 * Descarga una carátula sugerida por un catálogo externo (CEX o, desde #129,
 * IGDB) hacia el disco 'public', usada tanto al confirmar el alta/edición de
 * un juego desde su ficha de comprobación (GameController) como al confirmar
 * candidatos de la cola de revisión del identificado en bloque
 * (GameAutoIdentifyController, issue #128) — misma lógica de seguridad en un
 * único sitio, en vez de duplicarla.
 */
class ExternalCoverDownloader
{
     ...
     * (config('services.covers.allowed_hosts')) antes de pedirlo: sin eso,
    ...
    public function download(string $url): ?string
    {
        ...
        $allowedHosts = config('services.covers.allowed_hosts', []);
