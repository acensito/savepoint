...
@section('content')
    ...
    <div class="flex items-center justify-end gap-2 mb-3">
        <div class="inline-flex items-stretch h-8 bg-slate-900 border border-slate-800 rounded-lg overflow-hidden">
            <!-- Lista, compacta y texto son variantes de la TABLA de escritorio: en
                 móvil, donde siempre se ve la tarjeta (no la tabla), no tienen ningún
                 efecto, así que se ocultan y solo queda el botón de estantería (que sí
                 cambia algo visible en cualquier ancho). Compacta va primero por ser la
                 vista por defecto (ver users.games_view). -->
            ...
            <!-- #139: solo texto, sin carátulas ni espacio reservado para ellas —
                 ...
                 escritorio (la tarjeta móvil siempre lleva carátula, ver arriba). -->
