...
- **Sin segundo factor en el login**: la app está expuesta a internet, así que un password filtrado/reusado en otro
  sitio (credential stuffing) es un vector real, no solo teórico. Valorado (2FA por email, tarjeta de códigos de
  coordenadas, TOTP) y descartado por ahora; de momento se sigue solo con login por contraseña.
