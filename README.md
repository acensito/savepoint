...
- Listado de la colección (página principal) con miniatura, título, plataforma, edición, región, manual, conservación (estrellas), precio y fecha de compra, paginado (tamaño de página configurable desde el propio filtro: 10/20/50/100). La tabla de escritorio no incluye columnas de estado de juego (pendiente/jugando/terminado) ni de acciones (editar/borrar), para que quepa entera sin scroll horizontal en portátiles 1080p; el estado sigue disponible como filtro y en las tarjetas de móvil, y tanto él como editar/borrar viven en la ficha de detalle de cada juego.
...
- **Edición rápida** de la conservación y el estado de juego directamente desde la tarjeta del listado en móvil o la estantería (clic en una estrella, o en el estado para pasar al siguiente), por AJAX, sin abrir el formulario completo. En la tabla de escritorio la conservación es de solo lectura a propósito: se cambia desde el formulario de edición.
