...
- Listado de la colección (página principal) con miniatura, título, plataforma, edición, estado, región, manual, conservación (estrellas), precio y fecha de compra, paginado (tamaño de página configurable desde el propio filtro: 10/20/50/100).
