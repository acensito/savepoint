...
- **Fondo de la ficha con arte de IGDB**: botón "Elegir fondo" que muestra una muestra del arte promocional disponible en IGDB para elegir uno (o ninguno) como cabecera de la ficha del juego — nunca se aplica automáticamente, es siempre una elección explícita.
